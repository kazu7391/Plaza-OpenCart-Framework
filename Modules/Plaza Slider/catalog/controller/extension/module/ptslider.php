...
class ControllerExtensionModulePtslider extends Controller
{
    public function index($setting) {
        ...
        if($results) {
            ...
            if (file_exists(DIR_TEMPLATE . $this->config->get($this->config->get('config_theme') . '_directory') . '/stylesheet/plaza/slider/slider.css')) {
                $this->document->addStyle('catalog/view/theme/'.$this->config->get($this->config->get('config_theme') . '_directory').'/stylesheet/plaza/slider/slider.css');
            } else {
