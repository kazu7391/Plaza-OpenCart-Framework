$(document).ready(function () {
    ...
    $('.horizontal-menu .mega-menu-container').each(function () {
        if($(this).hasClass('right')) {
            if($(this).hasClass('full-width')) {
                ...
                var menu = $('.pt-menu-bar').offset();
                var dropdown = $(this).parent().offset();

                var dropdownRight = $('.pt-menu-bar').outerWidth() - dropdown.left;

                var i = (dropdownRight + $(this).outerWidth()) - ($('.pt-menu-bar').outerWidth());
        ...
        if($(this).hasClass('left')) {
            if($(this).hasClass('full-width') == false) {
                ...
                var i = (dropdown.left + $(this).outerWidth()) - (menu.left + $('.pt-menu-bar').outerWidth());
    ...
    $('.mobile-menu .pt-menu-bar .right').click(function () {
        var effect = $(this).closest('.pt-menu').find('.menu-effect').val();
        if(effect == "none") {
