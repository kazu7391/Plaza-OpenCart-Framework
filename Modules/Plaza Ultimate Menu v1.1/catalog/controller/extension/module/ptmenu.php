...
//        echo "<pre>"; var_dump($data['items']);die;
        ...
        if (file_exists('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/plaza/ultimatemenu/menu.css')) {
            $this->document->addStyle('catalog/view/theme/' . $this->config->get('config_template') . '/stylesheet/plaza/ultimatemenu/menu.css');
        } else {
            $this->document->addStyle('catalog/view/theme/default/stylesheet/plaza/ultimatemenu/menu.css');
        }
